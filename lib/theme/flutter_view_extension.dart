...
extension FlutterViewExtension on FlutterView {
  ...
  static const double responsive1024 = 1200;
  ...
  bool get isRegularTabletOrLess {
    if (logicalWidthSA < logicalHeightSA) {
      return (logicalWidthSA <= responsive800 || logicalHeightSA <= responsive1024);
    } else {
      return (logicalWidthSA <= responsive1024 || logicalHeightSA <= responsive800);
    }
  }
}
